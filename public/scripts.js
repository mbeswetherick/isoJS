...
},{"__browserify_process":15,"superagent":30}],2:[function(require,module,exports){
/**
...
},{"./router":4,"./routes":5}],3:[function(require,module,exports){
...
},{"moment":29}],4:[function(require,module,exports){
var __dirname="/";var director = require('director')
  , isServer = typeof window === 'undefined'
...
},{"./helpers":3,"director":16,"handlebars":17,"hbsfy/runtime":28}],5:[function(require,module,exports){
...
},{"./api_client":1}],"7WFXrU":[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<h1>Home</h1>\n\n<p>View <a href=\"/posts\">posts</a>.</p>\n\n<div class=\"debug\">Rendered ";
  if (stack1 = helpers.renderer) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.renderer; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "-side.</div>\n";
  return buffer;
  });

},{"hbsfy/runtime":28}],"app/views/index":[function(require,module,exports){
module.exports=require('7WFXrU');
},{}],"yj0ZJb":[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":28}],"app/views/layout":[function(require,module,exports){
module.exports=require('yj0ZJb');
},{}],"app/views/post":[function(require,module,exports){
module.exports=require('ihH1IG');
},{}],"ihH1IG":[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(((stack1 = helpers.formatDate || depth0.formatDate),stack1 ? stack1.call(depth0, depth0.created_at, options) : helperMissing.call(depth0, "formatDate", depth0.created_at, options)))
    + "</small>\n\n<p>";
  ...
  buffer += escapeExpression(stack2)
    + "</p>\n\n<div class=\"debug\">Rendered ";
  if (stack2 = helpers.renderer) { stack2 = stack2.call(depth0, {hash:{},data:data}); }
  else { stack2 = depth0.renderer; stack2 = typeof stack2 === functionType ? stack2.apply(depth0) : stack2; }
  buffer += escapeExpression(stack2)
    + "-side.</div>\n";
  return buffer;
  });

},{"hbsfy/runtime":28}],"app/views/posts":[function(require,module,exports){
module.exports=require('71K+vs');
},{}],"71K+vs":[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"./handlebars/base":18,"./handlebars/compiler":22,"./handlebars/runtime":26,"./handlebars/utils":27,"fs":14}],18:[function(require,module,exports){
/*jshint eqnull: true */
...
},{"./parser":23}],21:[function(require,module,exports){
...
},{"./ast":19,"./compiler":21,"./printer":24,"./visitor":25}],23:[function(require,module,exports){
// BEGIN(BROWSER)
...
},{"handlebars/lib/handlebars/base":18,"handlebars/lib/handlebars/runtime":26,"handlebars/lib/handlebars/utils":27}],29:[function(require,module,exports){
//! moment.js
//! version : 2.4.0
